...
reserveTestTable.add(['harunobu@example.jp','password','武田晴信','プレミアム会員','','','回答しない','','受け取る','横向き']);
reserveTestTable.add(['kagetora@example.jp','pass1234','長尾景虎','プレミアム会員','','','女性','','受け取らない','横向き']);
reserveTestTable.add(['masatora@example.jp','pass5678','真田昌虎','プレミアム会員','兵庫県加古川市','01234567890','その他','1960-12-11','受け取る','縦向き']);
reserveTestTable.add(['aiko@example.jp','passpass','直江愛子','プレミアム会員','兵庫県加古川市','01234567890','男性','1960-12-11','受け取る','縦向き']);
reserveTestTable.add(['kanta@example.jp','passwd00','山本寛太','一般会員','','','男性','','受け取らない','横向き']);

Feature('会員登録機能_By_Nexus9');
