...
reserveTestTable.add(['エステ・マッサージプラン','Wednesday','1','6','on','on','on','山本寛太','希望しない','','','144文字','部屋指定なし','72000','縦向き']);
...
Feature('Guest予約機能_By_Nexus6');

Data(reserveTestTable).Scenario('Guest予約_部屋タイプ確認_料金確認_By_Nexus6', async({I , current}) => {
