...
reserveTestTable.add(['harunobu@example.jp','password','武田晴信','一般会員','京都府宇治市','01234567890','男性','1960-12-11','受け取る','エステ・マッサージプラン','Saturday','9','6','on','on','on','電話でのご連絡','','off','部屋指定なし','606000','縦向き']);
reserveTestTable.add(['kagetora@example.jp','pass1234','長尾景虎','一般会員','','','男性','1960-12-11','受け取らない','素泊まり','Friday','1','2','off','on','on','希望しない','','144文字','シングル','15000','縦向き']);
reserveTestTable.add(['kagetora@example.jp','pass1234','長尾景虎','一般会員','','','男性','1960-12-11','受け取らない','貸し切り露天風呂プラン','Monday','3','6','on','on','off','メールでのご連絡','','144文字','部屋指定なし','186000','縦向き']);
reserveTestTable.add(['masatora@example.jp','pass5678','真田昌虎','一般会員','京都府宇治市','','男性','1960-12-11','受け取る','出張ビジネスプラン','Wednesday','9','1','on','off','on','メールでのご連絡','','144文字','シングル','81250','縦向き']);
reserveTestTable.add(['aiko@example.jp','passpass','直江愛子','一般会員','','01234567890','女性','1960-12-11','受け取らない','カップル限定プラン','Sunday','2','2','on','on','on','希望しない','','off','プレミアムツイン','44000','縦向き']);
reserveTestTable.add(['harunobu@example.jp','password','武田晴信','プレミアム会員','京都府宇治市','01234567890','男性','1960-12-11','受け取る','ディナー付きプラン','Tuesday','3','4','on','off','off','電話でのご連絡','','144文字','部屋指定なし','114000','縦向き']);
reserveTestTable.add(['kagetora@example.jp','pass1234','長尾景虎','プレミアム会員','','','男性','1960-12-11','受け取らない','テーマパーク優待プラン','Thursday','5','9','off','off','on','電話でのご連絡','01234567890','off','部屋指定なし','504000','縦向き']);
reserveTestTable.add(['kagetora@example.jp','pass1234','長尾景虎','プレミアム会員','','','男性','1960-12-11','受け取らない','プレミアムプラン','Wednesday','9','2','on','off','off','希望しない','','144文字','プレミアムツイン','208000','縦向き']);
reserveTestTable.add(['masatora@example.jp','pass5678','真田昌虎','プレミアム会員','京都府宇治市','','男性','1960-12-11','受け取る','テーマパーク優待プラン','Thursday','5','9','off','on','off','希望しない','','off','部屋指定なし','504000','縦向き']);
reserveTestTable.add(['aiko@example.jp','passpass','直江愛子','プレミアム会員','','01234567890','女性','1960-12-11','受け取らない','お得なプラン','Tuesday','1','1','off','off','off','メールでのご連絡','','144文字','部屋指定なし','6000','縦向き']);
reserveTestTable.add(['aiko@example.jp','passpass','直江愛子','プレミアム会員','','01234567890','女性','1960-12-11','受け取らない','カップル限定プラン','Wednesday','1','2','on','on','on','メールでのご連絡','','off','プレミアムツイン','22000','縦向き']);
