...
reserveTestTable.add(['素泊まり','Saturday','9','1','on','off','on','武田晴信','電話でのご連絡','12345678901','','144文字','シングル','65000','横向き']);
...
Feature('Guest予約機能_By_Nexus10');

Data(reserveTestTable).Scenario('Guest予約_部屋タイプ確認_料金確認_By_Nexus10', async({I , current}) => {
