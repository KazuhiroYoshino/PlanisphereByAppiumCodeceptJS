...
reserveTestTable.add(['harunobu@example.jp','password','武田晴信','一般会員','京都府宇治市','01234567890','男性','1960-12-11','受け取る','お得な特典付きプラン','Thursday','1','1','on','off','off','電話でのご連絡','','144文字','スタンダードツイン','8000','縦向き']);
reserveTestTable.add(['harunobu@example.jp','password','武田晴信','一般会員','京都府宇治市','01234567890','男性','1960-12-11','受け取る','素泊まり','Monday','1','2','on','on','off','メールでのご連絡','','144文字','シングル','15000','縦向き']);
reserveTestTable.add(['kagetora@example.jp','pass1234','長尾景虎','一般会員','','','男性','1960-12-11','受け取らない','カップル限定プラン','Saturday','2','2','on','off','off','電話でのご連絡','01234567890','off','プレミアムツイン','44000','縦向き']);
reserveTestTable.add(['masatora@example.jp','pass5678','真田昌虎','一般会員','京都府宇治市','','男性','1960-12-11','受け取る','エステ・マッサージプラン','Tuesday','1','6','off','off','off','メールでのご連絡','','144文字','部屋指定なし','54000','縦向き']);
reserveTestTable.add(['aiko@example.jp','passpass','直江愛子','一般会員','','01234567890','女性','1960-12-11','受け取らない','お得なプラン','Thursday','1','9','on','off','off','メールでのご連絡','','off','部屋指定なし','63000','縦向き']);
reserveTestTable.add(['harunobu@example.jp','password','武田晴信','プレミアム会員','京都府宇治市','01234567890','男性','1960-12-11','受け取る','貸し切り露天風呂プラン','Wednesday','1','6','off','on','off','電話でのご連絡','','144文字','部屋指定なし','60000','縦向き']);
reserveTestTable.add(['kagetora@example.jp','pass1234','長尾景虎','プレミアム会員','','','男性','1960-12-11','受け取らない','プレミアムプラン','Saturday','9','2','off','on','off','希望しない','','off','プレミアムツイン','202000','縦向き']);
reserveTestTable.add(['masatora@example.jp','pass5678','真田昌虎','プレミアム会員','京都府宇治市','','男性','1960-12-11','受け取る','お得な特典付きプラン','Sunday','9','9','off','on','off','メールでのご連絡','','144文字','スタンダードツイン','623250','縦向き']);
reserveTestTable.add(['masatora@example.jp','pass5678','真田昌虎','プレミアム会員','京都府宇治市','','男性','1960-12-11','受け取る','ディナー付きプラン','Sunday','3','4','on','off','on','メールでのご連絡','','144文字','部屋指定なし','126500','縦向き']);
reserveTestTable.add(['aiko@example.jp','passpass','直江愛子','プレミアム会員','','01234567890','女性','1960-12-11','受け取らない','出張ビジネスプラン','Saturday','1','1','off','off','off','希望しない','','off','シングル','9375','縦向き']);
...
Feature('Member予約機能_By_Pixel4');

Data(reserveTestTable).Scenario('Member予約_部屋タイプ確認_料金確認_By_Pixel4', async({I , current}) => {
