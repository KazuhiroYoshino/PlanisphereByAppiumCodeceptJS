...
reserveTestTable.add(['カップル限定プラン','Tuesday','2','2','off','off','off','直江愛子','メールでのご連絡','','aiko@example.com','144文字','プレミアムツイン','32000','縦向き']);
...
Feature('Guest予約機能_By_Pixel3');

Data(reserveTestTable).Scenario('Guest予約_部屋タイプ確認_料金確認_By_Pixel3', async({I , current}) => {
