...
reserveTestTable.add(['お得な特典付きプラン','Monday','1','1','off','off','off','真田昌虎','希望しない','','','off','スタンダードツイン','7000','縦向き']);
...
Feature('Guest予約機能_By_Nexus4');

Data(reserveTestTable).Scenario('Guest予約_部屋タイプ確認_料金確認_By_Nexus4', async({I , current}) => {
