...
reserveTestTable.add(['貸し切り露天風呂プラン','Thursday','3','6','on','off','off','柿崎家時','電話でのご連絡','23456789012','','144文字','部屋指定なし','193500','横向き']);
...
Feature('Guest予約機能_By_PixelC');

Data(reserveTestTable).Scenario('Guest予約_部屋タイプ確認_料金確認_By_PixelC', async({I , current}) => {
